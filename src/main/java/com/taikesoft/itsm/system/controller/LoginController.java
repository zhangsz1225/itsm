...
import com.taikesoft.itsm.system.service.LoginService;
import com.taikesoft.itsm.system.validator.LoginValidator;
...
public class LoginController extends Controller {
	...
	public void doLogin() {
		...
		if (ret.isOk()) {
			...
			ret.set("returnUrl", getPara("returnUrl", "/main"));    // 如果 returnUrl 存在则跳过去，否则跳去首页
		}
		renderJson(ret);
	}
