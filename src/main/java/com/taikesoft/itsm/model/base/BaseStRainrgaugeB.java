...
public abstract class BaseStRainrgaugeB<M extends BaseStRainrgaugeB<M>> extends Model<M> implements IBean {
	...
	public void setRgtm(java.util.Date rgtm) {
		set("rgtm", rgtm);
	}
	
	public java.util.Date getRgtm() {
		return get("rgtm");
	}
