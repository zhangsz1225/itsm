...
(function ($, window, document, undefined) {
    ...
    BaseForm.prototype.initBaseEntity = function () {
        ...
        //if (form.find('[name="isDelete"]').length == 0) {
            //form.prepend("<input type='hidden' name='isDelete' value='0'>");
        //}
        //if (form.find(':hidden[name="createTime"]').length == 0) {
            //form.prepend('<input type="hidden" name="createTime" data-flag="date" data-format="yyyy-mm-dd hh:ii:ss">');
        //}
